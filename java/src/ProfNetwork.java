...
public class ProfNetwork {
   ...
   private static void FriendList(ProfNetwork esql)
   {

   }
   private static void UpdateProfile(ProfNetwork esql)
   {
   }
   private static void NewMessage(ProfNetwork esql)
   {
   }

   private static void SendRequest(ProfNetwork esql)
   {
   }
